...
describe("Changing the parser", function () {
	it("should work with uppercassing", function () {
		...
		var xmlTemplater = createXmlTemplaterDocx(content, { tags: scope, parser: parser });
		xmlTemplater.render();
	...
	it("should work with loops", function () {
		...
		var xmlTemplater = createXmlTemplaterDocx(content, { tags: scope, parser: angularParser });
		xmlTemplater.render();
...
describe("Raw Xml Insertion", function () {
	it("should work with simple example", function () {
		...
		var scope = { complexXml: fs.readFileSync(path.resolve(__dirname, "raw-complex-docx.xml"), "utf8") };
		var doc = createXmlTemplaterDocx(content, { tags: scope });
		doc.render();
